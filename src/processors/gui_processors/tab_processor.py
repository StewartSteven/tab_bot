        ...
        self.modal_items = [
            {
                "label": "Adjustments",
                "style": discord.InputTextStyle.multiline,
                "placeholder": """user, Amount. New line separated""",
            }
        ]
        self.confirmation_view = TabConfirmationView
        self.set_items(self.modal_items)
...
class DeleteTabModal(BaseModal):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.modal_items = [
            {
                "label": "Tab ID",
                "placeholder": "Must be a valid and open tab. Use GET TAB to see available tabs.",
            }
        ]
        self.confirmation_view = TabConfirmationView
        self.set_items(self.modal_items)
...
class ListTabsModal(BaseModal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            embeds=[self.embed, results], ephemeral=True
        )
